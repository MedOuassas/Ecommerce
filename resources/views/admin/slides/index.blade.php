...
<div class="box">
    ...
    <div class="box-body table-responsive">
        {!! Form::open(['id' => 'form_data', 'url' => aurl('slides/destroy/all'), 'method' => 'delete']) !!}
...
<script>
    $(function () {
        $(document).on('click', '.btn_status', function (e) {
            ...
            $.ajax({
                url: '{{ aurl("slides/change-status") }}',
                dataType: 'json',
                type: 'post',
                data: {_token:'{{csrf_token()}}', slide_id: sld_id, slide_status: status },
