...
class SlideDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', 'admin.slides.btn.action')
            ->addColumn('checkbox', 'admin.slides.btn.checkbox')
            ->addColumn('photo', 'admin.slides.btn.photo')
            ->addColumn('status', 'admin.slides.btn.status')
            ->rawColumns([
                'action',
                'checkbox',
                'photo',
